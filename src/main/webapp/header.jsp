...
<nav class="navbar navbar-expand-lg navbar-waring bg-dark sticky-top">
    <a class="navbar-brand" href="http://localhost:${pageContext.request.localPort}${pageContext.request.contextPath}/index.jsp">SHOPPY</a>
